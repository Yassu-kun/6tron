...
#define PEER_GROUP_NAME         "Groupe 7"
...
{
    static bool peer_led_on = false;  // Toggle state: ON/OFF
    peer_led_on = !peer_led_on;       // Toggle the state

    // Publish "ON" or "OFF" to the peer group
    MQTT::Message message;
    message.qos = MQTT::QOS1;
    message.retained = false;
    message.dup = false;
